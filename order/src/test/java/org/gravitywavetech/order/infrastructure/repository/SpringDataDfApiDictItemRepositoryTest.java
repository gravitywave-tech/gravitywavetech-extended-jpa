...
@Slf4j
@SpringBootTest
public class SpringDataDfApiDictItemRepositoryTest {
    @Autowired
    private SpringDataDfApiDictItemRepository springDataDfApiDictItemRepository;
    ...
    public void save(){
        ...
        this.springDataDfApiDictItemRepository.save(item);
    ...
    public void saveAll(){
        ...
        this.springDataDfApiDictItemRepository.saveAll(items);
    }
}
